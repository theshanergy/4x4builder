...
import { getCachedGeometry, stitchSignature } from '../utils/terrain/geometryCache'
...
/**
 * Build terrain and water BufferGeometry for a quadtree tile.
 * Pure function — no side effects, no caching. Called only on a cache miss.
 */
function buildGeometry(node, terrainHelpers, edgeStitchInfo) {
