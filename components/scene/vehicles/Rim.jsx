...
const Rim = memo(({ rim, rim_diameter, rim_width, rim_color, rim_color_secondary, color, roughness }) => {
	...
	const { scene: rimScene, materials: rimMaterials } = useMemo(() => cloneWithMaterials(rimGltf.scene), [rimGltf.scene])
	...
	// Set rim color
	useEffect(() => {
		setMaterials(rimMaterials, color, roughness, rim_color, rim_color_secondary)
	}, [rimMaterials, setMaterials, rim_color, rim_color_secondary, color, roughness])
