...
function PlayerRow({ name, color, vehicleName, isLocal }) {
	return (
		<div className='flex items-center gap-2 p-2 bg-stone-900/50 rounded border border-stone-800/50'>
			...
			{vehicleName && <span className='text-xs text-stone-500 ml-auto'>{vehicleName}</span>}
		</div>
	)
}
	...
	return (
		<div className='field'>
			...
			<div className='flex flex-col gap-1'>
				<PlayerRow name='You' color={currentVehicle.color} isLocal />
