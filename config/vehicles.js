const vehicleConfigs = {
	...
	vehicles: {
		ripsaw_tracked_poc: {
			slug: 'ripsaw-tracked-poc',
			name: 'Ripsaw Prototype',
			year: 'POC',
			make: 'Ripsaw',
			model: '/assets/models/vehicles/ripsaw/ripsaw.glb',
			vehicle_class: 'tracked',
			wheel_offset: 1.15,
			driverPosition: [0.4, 1.45, 1.1],
			default_addons: {},
			addons: {},
			lighting: {},
			track: {
				...
				link_length: 0.18,
				link_height: 0.06,
				max_links_per_side: 96,
				wheels: [
					{ key: 'front_idler', rim_width: 16, rim_diameter: 22, position: [0, 0.28, 1.2], physics: true },
					{ key: 'front_road', rim_width: 16, rim_diameter: 22, position: [0, 0.28, 0.45], physics: true },
					{ key: 'center_front_road', rim_width: 16, rim_diameter: 22, position: [0, 0.28, -0.3], physics: true },
					{ key: 'center_rear_road', rim_width: 16, rim_diameter: 22, position: [0, 0.28, -1.1], physics: true },
					{ key: 'rear_drive_sprocket', rim_width: 16, rim_diameter: 26, position: [0, 0.34, -1.95], physics: true },
					{ key: 'front_return_roller', rim_width: 16, rim_diameter: 18, position: [0, 0.9, 2.05], physics: false },
					{ key: 'center_front_return_roller', rim_width: 16, rim_diameter: 12, position: [0, 1.07, 1.07], physics: false },
					{ key: 'center_rear_return_roller', rim_width: 16, rim_diameter: 12, position: [0, 1.13, 0.385], physics: false },
					{ key: 'rear_return_roller', rim_width: 16, rim_diameter: 12, position: [0, 1.18, -0.28], physics: false },
				],
			},
		},
		ripsaw_EV3_F4: {
			...
			year: 'EV3 F4',
			make: 'Ripsaw',
			model: '/assets/models/vehicles/ripsaw/ripsaw-EV3-F4.glb',
			vehicle_class: 'tracked',
			wheel_offset: 1.28,
			driverPosition: [0.4, 1.45, 1.1],
			default_addons: {},
			...
			track: {
				...
				max_links_per_side: 96,
				wheels: [
					{ key: 'front_idler', rim_width: 16, rim_diameter: 22, position: [0, 0.28, 1.58], physics: true },
					{ key: 'front_road', rim_width: 16, rim_diameter: 22, position: [0, 0.23, 0.92], physics: true },
					{ key: 'center_front_road', rim_width: 16, rim_diameter: 22, position: [0, 0.23, 0], physics: true },
					{ key: 'center_rear_road', rim_width: 16, rim_diameter: 22, position: [0, 0.23, -0.93], physics: true },
					{ key: 'rear_drive_sprocket', rim_width: 16, rim_diameter: 22, position: [0, 0.23, -1.6], physics: true },
					{ key: 'front_return_roller', rim_width: 16, rim_diameter: 22, position: [0, 1.05, 2.37], physics: false },
					{ key: 'center_front_return_roller', rim_width: 12, rim_diameter: 14, position: [0, 1.08, 1.02], physics: false },
					{ key: 'center_middle_return_roller', rim_width: 12, rim_diameter: 14, position: [0, 1.03, 0.18], physics: false },
					{ key: 'center_rear_return_roller', rim_width: 12, rim_diameter: 14, position: [0, 0.975, -0.82], physics: false },
					{ key: 'rear_return_roller', rim_width: 16, rim_diameter: 22, position: [0, 0.8, -2.25], physics: false },
				],
			},
			lighting: {
				lightbar: [
					...
					},
					{
						...
						rows: 2,
						color: 'white',
						position: [0.415, 0.738, 3],
						rotation: [0, 0, 0],
						pair: true,
					},
					{
						name: 'Top Side Lights',
						width: 1,
						rows: 10,
						color: 'white',
						position: [0.825, 1.195, -0.02],
						rotation: [0, 0.9, 0],
						pair: true,
					},
					{
						name: 'Middle Side Lights',
						width: 2,
						rows: 2,
						color: 'white',
						position: [1.46, 0.87, -0.58],
						rotation: [0, Math.PI / 2, 0],
						pair: true,
					},
					{
						name: 'Rear Side Lights',
						width: 2,
						rows: 2,
						color: 'white',
						position: [1.46, 0.82, -2.28],
						rotation: [0, Math.PI / 2, 0],
						pair: true,
					},
				],
	...
	wheels: {
		rims: {
			...
			kmc_terra: {
				make: 'KMC Wheels',
				name: 'KMC Terra',
				model: '/assets/models/wheels/rims/kmc_terra.glb',
				width: 0.5,
				od: 1,
			},
			method_312: {
				make: 'Method Race Wheels',
				name: 'Method 312',
				model: '/assets/models/wheels/rims/method_312.glb',
				width: 0.5,
				od: 1,
			},
			dirty_life_mesa_race: {
				make: 'Dirty Life',
				name: 'Dirty Life Mesa Race',
				model: '/assets/models/wheels/rims/dirty_life_mesa_race.glb',
				width: 0.5,
				od: 1,
			},
			fuel_syndicate: {
				make: 'Fuel Off-Road',
				name: 'Fuel Syndicate',
				model: '/assets/models/wheels/rims/fuel_syndicate.glb',
				width: 0.5,
				od: 1,
			},
			level_8_strike_6: {
